namespace STFU.Lib.GUI.Forms
{
	partial class AddYoutubeAccountForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.useExternalTlp.Controls.Add(this.useExternalCodeLabel, 1, 8);
			...
			this.useExternalTlp.Controls.Add(this.useExternalCodeTextbox, 3, 8);
			this.useExternalTlp.Controls.Add(this.signInButton, 5, 8);
			...
			this.useExternalTlp.RowCount = 10;
			...
			this.useExternalExplanationLabel.Size = new System.Drawing.Size(409, 47);
			...
			this.allowMailingCheckbox.Location = new System.Drawing.Point(10, 67);
